              ...
              {selectedPost && (
                <>
                  ...
                  <View className="flex-row gap-4 mt-2">
                    <Text className="text-gray-700 text-bodyMedium">
                      Tác giả : {selectedPost.author}
                    </Text>
                    <Text className="text-gray-700 text-bodyMedium">
                      Tên môn : {selectedPost.course}
                    </Text>
                  </View>
                  ...
                  <Text className="text-bodyMedium text-gray-700">
                    Mô tả :{" "}
                  </Text>
                  ...
                  <View>
                    ...
                    <View className="flex-row items-center mb-4 mt-4">
                      ...
                      <Text className="text-gray-600 flex-1">
                        {selectedPost.location || "Khu A - ĐHBK"}
                      </Text>
                    </View>
                    ...
                    <View className="flex-row items-center">
                      ...
                      <Text className="text-gray-600 flex-1">
                        {selectedPost.seller_phone || "09074350"}
                      </Text>
                    </View>
                  </View>
                  <View className="h-[1px] bg-gray-200 w-full my-4" />
                  <View className="mb-10">
                    <Text className="text-bodyMedium text-gray-700  mb-4">
                      Người bán
                    </Text>
                    <View className="flex-row items-center">
                      ...
                      <View className="ml-3 gap-2">
                        <Text className="font-bold text-gray-900">
                          {selectedPost.seller_name || "Nguyễn Văn A"}
                        </Text>
                        <Text className="text-gray-400 text-xs">
                          Đăng {selectedPost.order_time || "10/01/2025"}
                        </Text>
                      </View>
                    </View>
                  </View>
